 ...
 * @since 0.0.6
 */
public class NewIngredientDialog extends JDialog {

    /* generated serial id */
	private static final long serialVersionUID = -3335371756763874955L;
	
	/**
     * Creates new form NewIngredientDialog
     */
    public NewIngredientDialog() {
        initComponents();
        saveIngredientButton.addActionListener(new NewIngredientController());
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(NewIngredientDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewIngredientDialog().setVisible(true);
            }
        });
    }
